...
export default function BookActivityModal({ isOpen, onClose, activityCode }: BookActivityModalProps) {
  const [state, handleSubmit] = useForm("mqabbokn");
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] flex flex-col relative">
        ...
        <div className="p-6 border-b flex justify-between items-center">
          <h2 className="text-xl font-semibold text-gray-800">Book This Activity</h2>
          <button
            onClick={handleClose}
