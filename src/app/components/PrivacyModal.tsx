        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <section>
              ...
              <p>
                If any changes to this Policy substantially affect how AXISMedEd treats or handles personal data that has already been collected by AXISMedEd, we will notify you by email (if AXISMedEd has a valid email address to use) and give you thirty (30) days to opt-in to the changes as they pertain to your information. If you do not opt-in, your information will continue to be used in a manner that is consistent with the version of this Policy under which it was collected.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Collection of Personal Data</h2>
              <p>
              ...
              <p>
                Additionally, AXISMedEd may collect inferences about AXISMedEd content we think may be of interest to you based on your apparent preferences from the categories of professional information we collect about you.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Personal Data Sources</h2>
              ...
              <p>
                AXISMedEd may collect some of your contact information and professional information from pharmaceutical companies that provide us with physician level data (PLD), which we then use to track the content you listen to and/or view on or through the Services. The pharmaceutical companies that provide us with your PLD may receive professional information about any AXISMedEd courses you attend or other Services you use as a result of this process. This exchange of PLD and other professional information may result in you receiving advertising content that is based on the AXISMedEd content you listen to and/or view, and other Services you use.
              </p>
            </section>

            <section>
              <p>
                AXISMedEd generally will not ask you to provide any sensitive data, such as your religious beliefs, citizenship status, sexual orientation, or your race or ethnicity, but you may be able to voluntarily provide such sensitive data in any content that you may upload or post on or through the Services. To the extent you include any sensitive data in content you voluntarily make available through the Services, you hereby acknowledge and agree that such data may be processed by AXISMedEd as necessary to provide the Services in accordance with your instructions.
              </p>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Online Tracking Technologies</h2>
              <h3 className="text-xl font-semibold text-gray-700 mb-3">Device information, cookies, and other online tracking tools</h3>
              <p>
                There are other areas of the Services where Personal Data or other information may be collected from you in an automated manner. When you visit or use certain Services, for example, we may automatically collect certain Device Information about your computer, browser or device that includes information about your web browser, such as your IP address, time zone, and some of the cookie identifiers that are installed on your device. AXISMedEd will treat such device information as Personal Data to the extent such device information is reasonably capable of identifying a particular individual.
              </p>
              <p>
              ...
              <h3 className="text-xl font-semibold text-gray-700 mb-3 mt-6">Other third-party online tools</h3>
              <p>
                ...
                <table className="w-full border-collapse border border-gray-300">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="border border-gray-300 px-4 py-2 text-left">Third Party Source / Data Recipient</th>
                      <th className="border border-gray-300 px-4 py-2 text-left">How to Manage Privacy Settings</th>
                      <th className="border border-gray-300 px-4 py-2 text-left">More Information</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
              ...
              <h3 className="text-xl font-semibold text-gray-700 mb-3 mt-6">Identification of site visitors through audience identification tool</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-gray-700 mb-3 mt-6">Mobile Data Collection</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">How We Use Collected Information</h2>
              ...
              <ul className="list-disc list-inside mt-3 space-y-2">
                ...
                <li><strong>To personalize User experience:</strong> We may use information to provide Users with tailored content based on AXISMedEd courses you attend or other Services you use, and we may use information in the aggregate to understand how our Users as a group use the Services.</li>
              ...
              <p>
                By providing to AXISMedEd the Personal Data and other information referenced above, you agree that AXISMedEd may use the Personal Data and other information in accordance with the terms of this policy.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Sharing Your Personal Information</h2>
              <p>
              ...
              <ul className="list-disc list-inside mt-3 space-y-2">
                <li><strong>Professional Information</strong> with a search service to help us look up your NPI number, or with pharmaceutical companies and providers of advertising services in connection with the exchange of your PLD as described above;</li>
                <li><strong>Device Information</strong> with our content delivery vendor to provide content on or through the Services, and with analytics service providers with whom we have contractually committed to provide data for analytical purposes; and/or</li>
                <li><strong>Payment information</strong> to our credit card or other payment processors to facilitate purchases made through our Services;</li>
                <li><strong>Contact Information</strong> with our email and shipping vendors for the purpose of sending out newsletters, surveys, or marketing materials from AXISMedEd.</li>
                <li><strong>Communications Information</strong> with our service providers in order to facilitate the chat service, to the extent that you may use our customer service chat bot;</li>
                <li><strong>Any Personal Data</strong> to our IT service and data storage providers to store our information and provide IT support and maintenance services; and/or</li>
                <li><strong>Any Personal Data</strong> to our affiliates to fulfill any of the processing activities described in this Policy.</li>
              </ul>
              <p>
                We may share your information with these third parties unless you have specifically requested to be removed from our database and AXISMedEd has no other legal obligation to retain your information and process it as necessary to fulfill contractual obligations or for other legitimate business purposes.
              </p>
              <p>
                We participate in the Healthcare Communications Network℠ which is owned and operated by IQVIA. Participation in the Healthcare Communications Network provides us with tools to better understand and analyze who is using our Services, and to personalize User experiences through the Services. We share certain of your Personal Data with the operators of the Healthcare Communications Network. This information includes your email address, your name, your NPI number and other information we obtain when you register to use the Services, or visit the Healthcare Communications Network. HealthCare Communications Network will use this information primarily to send you emails with information specifically tailored to your medical interest. You will receive an email providing you with a mechanism to unsubscribe from the Network's emails and from AXISMedEd's use of the Network's tools to track and analyze your visits to and use of our Services.
              </p>
              <p>
              ...
              <p>
                If AXISMedEd is involved in a merger, acquisition or asset sale, your Personal Data may be transferred.
              </p>
              <p>
              ...
              <p>
                Other than what is referenced above, the Personal Data and other information collected from you is not shared with nor sold to any person or entity outside of AXISMedEd. AXISMedEd does not knowingly collect or sell the Personal Information of minors under 16 years of age.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Disclosures for Investigation and Regulatory Purposes</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Your Choices Regarding Your Personal Data</h2>
              <p>
                Your provision of Personal Data and other information to AXISMedEd means you agree that we may collect, use and disclose your information according to the terms of this Policy. If you do not agree with these terms, please do not provide any Personal Data. However, certain Services can only be offered if you provide your Personal Data to AXISMedEd.
              </p>
              <p>In connection with AXISMedEd's collection and use of your Personal Data, and depending on where you reside, you may have a right to:</p>
              <ul className="list-disc list-inside mt-3 space-y-2">
                <li>Confirm whether AXISMedEd has collected and is processing your Personal Data and, if so, you may have a right to request access to or correction of your Personal Data;</li>
                <li>Obtain a copy of Personal Data that AXISMedEd maintains about you in a portable and readily usable format, if technically feasible, that would allow you to transfer such Personal Data to another service or provider, where the applicable processing is carried out by automated means;</li>
                ...
                <li>Request details on the specific pieces of Personal Data that AXISMedEd has collected about you;</li>
                <li>Request that AXISMedEd delete or properly dispose of copies of Personal Data it has collected about you, subject to contractual and legal restrictions; and not be discriminated against, in terms of the quality and prices offered in connection with our Services, because you exercised these rights regarding the collection, use and sharing of your Personal Data;</li>
                <li>Submit an appeal to a regulatory authority if we reject your request to exercise any of these rights (if applicable).</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">How to Exercise Your Rights</h2>
              <p>
                If you would like to request the ability to access, review, edit, delete or have us otherwise dispose of any copies of the Personal Data AXISMedEd collected from you, if you would like to opt-out of receiving further information, if you want to limit what Personal Data AXISMedEd shares, if you otherwise wish AXISMedEd to stop using your Personal Data in the manners specified in this Policy, or if you would like to exercise the above rights in any other way (subject to any applicable legal exceptions), please contact us at <a href="mailto:info@axismeded.com" className="text-blue-600 hover:text-blue-800">info@axismeded.com</a> or by calling us at 1-866-390-9909 (Toll-Free).
              </p>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Verifying Your Identity</h2>
              <p>
                AXISMedEd is required to verify the identity of any person or entity that requests the disclosure or deletion of Personal Data. Making a verifiable consumer request does not require you to create an account with us, but if you have a password-protected account, we will use our existing authentication procedures to verify your identity. For most other requests, AXISMedEd will ask you to provide information that matches at least two pieces of Personal Data we store about you before responding to your request. If you would like to request the specific pieces of your Personal Data that AXISMedEd has collected, or if you would like us to delete highly sensitive information, you will need to match at least three pieces of information we store about you, and you must provide a signed declaration under penalty of perjury that you are the consumer whose Personal Data you are requesting. We will only use Personal Data provided in a verifiable consumer request to verify the requestor's identity or authority to make the request.
              </p>
              <p>
                We cannot respond to your request or provide you with Personal Data if we cannot verify your identity or authority to make the request and confirm the Personal Data relates to you. Under such circumstances, AXISMedEd may follow up with you for additional information as reasonably necessary to authenticate your request. Subject to applicable legal requirements, if AXISMedEd refuses to act on a request you make based on the rights listed at the beginning of this section, you may have a right to submit an appeal by contacting us using the same method as when you made the initial request. In the event AXISMedEd must deny your appeal, we will provide a way for you to forward your complaint to the appropriate legal authorities.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Data Deletion Considerations</h2>
              <p>
                Any removal of information or content by AXISMedEd does not ensure or guarantee complete or comprehensive removal in all places. The content or information may have been shared or reposted by other parties, or federal or state law may require maintenance of the content or information. AXISMedEd will do its best to accommodate your request to delete Personal Data we collected from you, but we cannot guarantee we can remove all Personal Data from the specified uses. If the request relates to information that AXISMedEd needs to make the Services function properly for you, you may not be able to use the Services properly moving forward.
              </p>
              <p>
                AXISMedEd reserves the right to maintain proper records as required by law, or for otherwise legitimate business purposes to the extent permitted by law, even if such records contain your Personal Data.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">How to Exercise Your Opt Out Rights / Do Not Track</h2>
              <p>
              ...
              <p>
                Options you select through these third-party services are browser- and device-specific, and there is no guarantee that these industry-provided opt-out tools will prevent all targeted advertising. As noted previously in this Policy, it is possible that third parties may collect or receive information through the Services. Since it is possible that some of these third parties may respond differently than AXISMedEd to "do not track" requests, you should consult the applicable privacy policies of those third parties for that information.
              </p>
              <p>
                If you would like to opt-out of receiving further promotional emails from AXISMedEd, please follow the opt-out instructions at the bottom of the email or send AXISMedEd a detailed message at <a href="mailto:info@axismeded.com" className="text-blue-600 hover:text-blue-800">info@axismeded.com</a>.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Data of Minors</h2>
              <p>
                AXISMedEd does not knowingly collect any information from minors, nor are the Services directed at or intended for minors. If a minor uploads/posts information on or through the Services that is publicly available, the minor has a right to request that such information be removed from public viewing. A minor may request uploads/posts or other information to be removed by sending a detailed message at <a href="mailto:info@axismeded.com" className="text-blue-600 hover:text-blue-800">info@axismeded.com</a>. Any removal of content by AXISMedEd does not ensure or guarantee complete removal of the content in all places. The content may have been reposted by other parties, or federal or state law may require maintenance of the content or information.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                As to Personal Data we collect, AXISMedEd's Services use, implement and maintain industry standard security measures to protect against unauthorized access, alteration, disclosure or destruction of your Personal Data and other data stored on or through our Services, both in storage and in transmission.
              </p>
              <p>
                However, while AXISMedEd takes the protection of your Personal Data seriously, you should exercise discretion in what information you disclose and/or transmit online, including on or through any of our online Services. No data transmission over the internet can be assured to be completely secure, as any transmitted information may be intercepted by others before it reaches AXISMedEd. As a result, AXISMedEd does not ensure or warrant the security of any information that you transmit to us, and you do so at your own risk. If you are concerned about sending information to AXISMedEd over the internet, please send the information by mail or call us to make other arrangements. AXISMedEd is not responsible for the security of information sent over the internet.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">How Long We Keep Your Personal Data</h2>
              <p>
                AXISMedEd retains collected information for a reasonable amount of time in order to fulfill the stated purpose for why the information was collected or for other legitimate purposes such as ensuring security of our data and systems, complying with our legal obligations, complying with tax, audit, or other books and record policies, resolving disputes, conducting internal investigations, and enforcing our agreements or other legal rights. Due to the different purposes for retaining your Personal Data, the actual retention timeframes may vary depending on the type of Personal Data we collect from you and the purposes for which we use your Personal Data. AXISMedEd reserves the right to maintain proper business records as required by law, or for otherwise legitimate business purposes to the extent permitted by law, even if such records contain your Personal Data. If AXISMedEd determines that collected information is no longer needed, it will delete such information or anonymize the information so that it can no longer be attributed to you. Our collection times will be consistent with applicable law.
              </p>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">How We Handle E.U. Data</h2>
              <p>
                If you are a User residing within the European Economic Area (the "EEA," which includes the 27 European Union Member States, Iceland, Norway and Liechtenstein), Switzerland or the United Kingdom (collectively, the "EU"), then AXISMedEd handles your Personal Data according to the terms of this Policy, unless the exceptions in this section apply, pursuant to the General Data Protection Regulation ("GDPR").
              </p>
              <p>
                AXISMedEd will collect, process and use your Personal Data as described in this Policy and for the purposes set forth in this Policy. With the exception of uses for which we have obtained your consent, your Personal Data is processed in support of legitimate interests as described in this Policy.
              </p>
              <p>
                AXISMedEd's Services may use "cookies" to enhance the User's experience. If you are a User residing within the EU, you can find out more about cookies and how to manage them by viewing and exercising the options available to you in our Cookie Policy, which can be found at https://www.axismeded.com/privacy/cookielist/.
              </p>
              <p>
                If you are a User residing within the EU, we will seek your consent before using your Personal Data to serve you relevant information, content and educational materials based on your personal preferences, interests, location and other information that you provide to AXISMedEd in connection with your account for the Services.
              </p>
              <p>
              ...
              <p>
                Under the GDPR, Users in the EU have the following rights regarding your Personal Data:
              </p>
              <ul className="list-disc list-inside mt-3 space-y-2">
                <li>the right to request details on the Personal Data we hold about you at any time;</li>
                <li>the right to update and correct any inaccurate Personal Data AXISMedEd holds about you;</li>
                <li>the right to withdraw any consent for marketing activities or processing of Personal Data that you might have provided to AXISMedEd;</li>
                <li>the right to request erasure of Personal Data;</li>
                <li>the right to request restriction of AXISMedEd's processing of your Personal Data;</li>
                <li>the right to object at any time to AXISMedEd's processing of Personal Data concerning you; and</li>
                <li>the right to request the portability of Personal Data that you have provided to AXISMedEd.</li>
              </ul>
              <p>
                If you would like to review, edit or delete any of the Personal Data AXISMedEd collected from you, if you wish AXISMedEd to stop using your Personal Data in the manners specified in this Policy, or if you would like to exercise the rights listed above in any other way, please contact us at <a href="mailto:privacy@ushealthconnect.com" className="text-blue-600 hover:text-blue-800">privacy@ushealthconnect.com</a>.
              </p>
              <p>
                Under the GDPR, Users in the EU also have the right to lodge a complaint about AXISMedEd's processing of your Personal Data with a supervisory authority. In particular, such Users may lodge a complaint in the Member State where the User lives or works or where the alleged violation took place.
              </p>
              <p>
                To protect your Personal Data, AXISMedEd's Services use appropriate technical and organizational security measures to protect against unauthorized access, alteration, disclosure or destruction of your Personal Data and other information stored on or through our Services.
              </p>
              <p>
                AXISMedEd retains Personal Data only for as long as necessary to fulfill the stated purpose for which the Personal Data was collected or otherwise processed, and thereafter for a variety of legitimate legal or business purposes. These may include retention periods that are: (i) mandated by law, contract or similar obligations applicable to AXISMedEd's business operations; (ii) for preserving, resolving, defending or enforcing our legal/contractual rights; or (iii) needed to maintain adequate and accurate business and financial records. We will delete your Personal Data as soon as the respective purpose of use is not applicable anymore and no legal obligation to retain such data exists. If you have any questions about the security or retention of your Personal Data, you can contact us at <a href="mailto:privacy@ushealthconnect.com" className="text-blue-600 hover:text-blue-800">privacy@ushealthconnect.com</a>.
              </p>
              <p>
                Your Personal Data may be disclosed to and processed by staff operating in the United States. Disclosure will be to individuals who work for AXISMedEd, our subsidiaries, related companies, and companies with which we have contracted to process or store this data on AXISMedEd's behalf. The individuals and organizations that receive Personal Data as a result of international transfers out of the EU are obligated to use and protect your Personal Data in accordance with requirements under the GDPR and they must comply with appropriate security measures to protect your information.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">International Use & Transfers</h2>
              <p>
            ...
            <section>
              ...
              <p>
                The Services may contain links to external online locations, including those embedded in third-party advertisements or sponsor information, which are not controlled by AXISMedEd. AXISMedEd is not responsible for the privacy practices and data collection policies for such third-party services. Additionally, we are not responsible for the data processing practices of the internet browser service you choose to use when accessing our Site. You should consult the privacy policies of any third-party services before using or going to their websites or apps.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Your Acceptance of These Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Terms and Conditions of Use</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Information on Our Services</h2>
              <p>Need some information or assistance? We're close by, just reach out and we will get back to you as soon as possible.</p>
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <p><strong>EMAIL:</strong> <a href="mailto:info@axismeded.com" className="text-blue-600 hover:text-blue-800">info@axismeded.com</a></p>
                <p><strong>PHONE:</strong> 215.358.0555</p>
                <p><strong>MAIL:</strong> 1301 Virginia Drive, Ste 300, Fort Washington, PA 19034</p>
              </div>
              <p className="mt-4">
                AXISMedEd intends to strictly enforce this Policy. If you believe there has been some violation of this Policy, please contact AXISMedEd.
              </p>
            </section>

            <section className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-600">
                <strong>This Policy is effective as of April 15, 2024</strong>
              </p>
            </section>
          </div>
        </div>
